...
\title{A Temporal Bayesian ETAS Analysis of the 2019 Ridgecrest Earthquake 
Sequence: \\ Comparing the Omori-Utsu and Alternative Aftershock Decay Functions}
...
\begin{itemize}
    ...
    \item Include a statement on how large language models or grammar tools were used in the writing of your research report, as a whole. For example, ``For this report, GPT-4o was used to copy-edit introduction and conclusion text via ChatGPT graphical user interface. Grammarly was used to improve the quality of written English throughout the report. Where the output of specific queries is included in the document this is clearly quoted and cited as personal communications."
\end{itemize}
